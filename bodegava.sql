...
-- Tiempo de generación: 16-08-2022 a las 20:45:45
...
(1, '¿Por qué es interesante tener uvas de distintos terroirs?', 'Con el terruño como punto de partida para obtener ejemplares únicos y singulares', 'El concepto de terroir representa la columna vertebral de la vitivinicultura actual y de nuestra filosofía de elaboración: para nosotros, tal como dice el Ing. Rafael Maturanno (p), el vino nace en la finca. La interacción entre el microclima, el suelo, la geographic, las vides y el trabajo humano en un sitio determinado otorga al vino un carácter y una personalidad específica que se percibe a través de sus aromas, sabores y texturas.'),
